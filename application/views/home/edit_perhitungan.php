...
<body>
        ...
        <div class="drawer-content">
            ...
            <div class="w-full px-5 mt-4">
                <div class="mt-3 rounded-lg bg-primary p-10 h-32 relative overflow-hidden flex items-center group">
                    <h1 class="text-3xl font-bold text-white z-10"><i class="bi bi-gear-fill"></i> Edit Perhitungan</h1>
            ...
            <div class="mb-5 gap-3 grid sm:grid-cols-1 md:grid-cols-5 lg:grid-cols-5 sm:items-center md:items-start lg:items-start sm:mt-3 justify-center p-2">
                ...
                <div class="md:col-span-2 shadow-lg bg-base-100 rounded-lg p-7 md:mx-0 mt-0 sm:mx-auto grid lg:grid-cols-1 lg:grid-rows-1 sm:grid-cols-1 gap-3 overflow-x-auto">
                    <div class="form-control">
                        ...
                        <input required id="b" type="number" value="<?= $hitung['b'] ?>" placeholder="" name="balok" class="input w-full input-bordered" />
                    </div>
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">$(d)$ Tinggi Efektif Balok (inci)</span>
                        </label>
                        <input id="d" type="number" placeholder="" value="<?= $hitung['d'] ?>" name="tinggi" class="input input-bordered" />
                    </div>
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">$(As)$ Luas Tulangan Tarik (inci$,^2$)</span>
                        </label>
                        <input id="as" type="number" placeholder="" value="<?= $hitung['as2'] ?>" name="luas" class="input input-bordered" />
                    </div>
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">$(f'c)$ Kekuatan Mutu Beton (psi)</span>
                        </label>
                        <input id="fc" type="number" placeholder="" name="kekuatan" value="<?= $hitung['fc'] ?>" class="input input-bordered" />
                    </div>
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">$(F_y)$ Mutu Baja (psi)</span>
                        </label>
                        <input id="fy" type="number" placeholder="" name="mutu" value="<?= $hitung['fy'] ?>" class="input input-bordered" />
                    ...
                    <div class="form-control flex flex-row gap-3 items-end ">
                        ...
                        <a href="/home/history/" class="btn btn-info">Kembali</a>
                    </div>
                    <!-- Submit button end -->
                </div>
                <!-- Box hasil start -->
    ...
    <script>
        ...
        function hitung(update = false) {
            ...
            loading();
            let url = `/api/hitung/id/<?= $hitung['id'] ?>?b=${input['b']}&d=${input['d']}&as=${input['as']}&fy=${input['fy']}&fc=${input['fc']}`;
            if (update) {
                url += '&update=true';
            }
