...
<meta charset="UTF-8">
	...
	<title>SIPerba | Tambah User</title>
</head>
        ...
        <div class="drawer-content">
            ...
            <div class="w-full px-5 mt-4">
                <div class="mt-3 rounded-lg bg-primary p-10 h-32 relative overflow-hidden flex items-center group">
                    <h1 class="text-3xl font-bold text-white z-10"><i class="bi bi-gear-fill"></i> Add User</h1>
                ...
                <div class="mt-3 rounded-lg shadow p-3">
					...
					<div class="form-control w-full">
						...
						<select class="select select-bordered w-full" name="" id="">
                    ...
                    <div class="form-control mt-4 w-64 grid grid-cols-2 gap-3">
						<button class="btn btn-primary">Simpan</button>
						<a href="/home/users" class="btn btn-error">Back</a>
                    </div>
                </div>
            </div>
